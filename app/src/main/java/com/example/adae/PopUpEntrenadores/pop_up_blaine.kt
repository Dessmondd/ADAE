...
class pop_up_blaine : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val view = findViewById<ImageView>(R.id.erikacard)
        if(language == "English"){
            view.setImageResource(R.drawable.canelaeng)
        }
        if(language == "Deutsch"){
            view.setImageResource(R.drawable.canelaaleman)
        }
