...
class pop_up_brock : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pop_up_brock)
        ...
        val view = findViewById<ImageView>(R.id.erikacard2)
        if(language == "English"){
            view.setImageResource(R.drawable.plateadaengl)
        }
        if(language == "Deutsch"){
            view.setImageResource(R.drawable.plateadaaleman)
        }
